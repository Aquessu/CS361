...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		emp3.whoAmI();
		// TODO To complete
		// emp3.whoAmI(); // prints PART TIME EMPLOYEE because whoAmI() is defined in 
							// PartTimeEmployee before checking Employee.
		...
		// because you cannot down cast a superclass into subclass when the superclass
		// does not fit the subclass.
